...
(function(){var t,r=function(t,r){return function(){return t.apply(r,arguments)}};t=function(){function t(t){var n;this.$scope=t,this.update=r(this.update,this),this.status=null,this.disabled=!1,this.inputs=[],n=this.$scope.$watch(this.update),this.$scope.$on("$destroy",n)}return t.prototype.update=function(){return this.status=null,this.inputs.every(function(t){return t.$dirty&&!t.$pending||t.$$parentForm.$submitted})?(this.status=this.inputs.every(function(t){return t.$valid})?"success":"error",this.$scope.$$phase?void 0:this.$scope.$digest()):void 0},t.prototype.addInput=function(t){return this.inputs.push(t)},t}(),angular.module("ng-form-group").controller("FormGroupController",["$scope",t]).directive("formGroup",function(){return{restrict:"C",require:"formGroup",controller:"FormGroupController",link:function(t,r,n,o){var e;return r.hasClass("form-group-without-feedback")||0===o.inputs.length?(o.disabled=!0,void 0):(e=t.$watch(function(){return o.status},function(t){return r.removeClass("has-error has-success"),t?r.addClass("has-"+t):void 0}),t.$on("$destroy",e))}}}).directive("formControl",function(){return{restrict:"C",require:["?ngModel","?^formGroup"],link:function(t,r,n,o){var e,s;return s=o[0],e=o[1],e&&!e.disabled?s&&e?e.addInput(s):void 0:void 0}}})}).call(this);
